...
const Placeholder = ({ name }: { name: string }) => (
  <div className="min-h-screen flex items-center justify-center bg-matte-black pt-20">
    <div className="text-center">
      <h1 className="text-4xl font-cinzel text-gold-elegant mb-4">{name}</h1>
      <p className="text-cream/60">Halaman ini sedang dalam tahap restorasi digital.</p>
    </div>
  </div>
);
        ...
        <footer className="py-12 px-6 border-t border-white/5 bg-matte-black text-center">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="flex justify-center gap-8">
              <a href="#" className="text-cream/60 hover:text-gold-elegant transition-colors">Instagram</a>
