    ...
    <div className="relative min-h-screen">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
          ...
          >
            <h1 className="text-5xl md:text-8xl font-cinzel font-bold mb-6 tracking-wider leading-tight">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-4 pt-12">
              <div className="aspect-[3/4] rounded-lg overflow-hidden glass border border-white/10 grayscale hover:grayscale-0 transition-all duration-700">
                <img src="https://images.unsplash.com/photo-1518548419970-58e3b4079ab2?q=80&w=2670" alt="Culture" className="w-full h-full object-cover" />
              </div>
              <div className="aspect-square rounded-lg overflow-hidden glass border border-white/10 grayscale hover:grayscale-0 transition-all duration-700">
                <img src="https://images.unsplash.com/photo-1544644181-1484b3fdfc62?q=80&w=2670" alt="Kingdom" className="w-full h-full object-cover" />
              </div>
            </div>
            <div className="space-y-4">
              <div className="aspect-square rounded-lg overflow-hidden glass border border-white/10 grayscale hover:grayscale-0 transition-all duration-700">
                <img src="https://images.unsplash.com/photo-1596431969248-18e3a2b72ce2?q=80&w=2670" alt="Art" className="w-full h-full object-cover" />
              </div>
              <div className="aspect-[3/4] rounded-lg overflow-hidden glass border border-white/10 grayscale hover:grayscale-0 transition-all duration-700">
                <img src="https://images.unsplash.com/photo-1518709268805-4e9042af9f23?q=80&w=2670" alt="Nature" className="w-full h-full object-cover" />
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { 
                ...
                path: "/kingdoms",
                image: "https://images.unsplash.com/photo-1605649406093-f25492476594?q=80&w=1000"
              },
              { 
                title: "Syair & Sastra", 
