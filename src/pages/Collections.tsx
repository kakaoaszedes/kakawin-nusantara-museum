...
export default function Collections() {
  ...
  useEffect(() => {
    const fetchArtefacts = async () => {
      try {
        console.log("Fetching artefacts from budaya table...");
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-matte-black flex items-center justify-center text-white">
        Loading koleksi...
      </div>
    );
  }
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row justify-between items-end gap-8 mb-12">
          <div>
            ...
            <p className="text-cream/60 font-light tracking-wide">
              Menyusuri warisan yang tak lekang, menjaga ingatan dari masa ke masa
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 w-full md:w-auto">
            <div className="relative group">
              <Search
                className="absolute left-4 top-1/2 -translate-y-1/2 text-cream/30 group-focus-within:text-gold-elegant transition-colors"
                size={20}
              />
          ...
          {filteredArtefacts.map((item, idx) => (
            ...
            >
              ...
              <div className="p-8">
                ...
                <h3 className="text-2xl font-cinzel mb-3 text-white group-hover:text-gold-elegant transition-colors">
                  {item.title}
                </h3>
        ...
        {/* Empty State */}
        {!loading && filteredArtefacts.length === 0 && (
            ...
            >
              ...
              >
                ...
                <div className="md:w-1/2 p-8 md:p-16 overflow-y-auto">
                  ...
                  <span className="text-gold-elegant font-cinzel text-sm tracking-[0.3em] uppercase mb-4 block">
                  ...
                  <div className="flex gap-12 mb-10 border-b border-white/5 pb-8">
                    <div>
                      <span className="text-xs text-cream/30 uppercase tracking-widest block mb-1">
                        Region
                      </span>

                      <span className="text-gold-elegant">
                        {selectedItem.region || "-"}
                      </span>
                    </div>
                  ...
                  <div className="space-y-8">
                    <div>
                      <h4 className="font-cinzel text-lg text-white mb-3">
                        Deskripsi
                      </h4>
                  ...
                  <div className="mt-12 flex gap-4">
                    <button className="flex-1 bg-gold-elegant text-matte-black py-4 rounded-xl font-bold hover:bg-white transition-all">
                      Audio Narasi
                    </button>

                    <button className="flex-1 border border-white/10 py-4 rounded-xl font-bold hover:bg-white/5 transition-all">
                      Lihat 3D Model
                    </button>
                  </div>
                </div>
