    ...
    const fetchEvents = async () => {
      try {
        ...
        const sortedData = [...filteredData].sort((a, b) => {
          ...
          const isBCE_A =
            a.year?.toLowerCase().includes("sm") ||
            a.year?.toLowerCase().includes("bc") ||
            a.year?.toLowerCase().includes("sebelum");

          const isBCE_B =
            b.year?.toLowerCase().includes("sm") ||
            b.year?.toLowerCase().includes("bc") ||
            b.year?.toLowerCase().includes("sebelum");
      ...
      <div className="max-w-7xl mx-auto">
        ...
        {loading ? (
          <div className="flex flex-col items-center justify-center py-40 gap-6">
            <Loader2
              className="animate-spin text-gold-elegant"
              size={40}
            />

            <span className="text-gold-elegant font-cinzel tracking-widest text-sm uppercase">
              Membuka Gulungan Sejarah...
            </span>
          </div>
        ) : (
          <div className="relative">
            ...
            {filteredEvents.length > 0 ? (
                ...
                {filteredEvents.map((event, index) => (
                  ...
                  >
                    ...
                    <div className="flex-1 text-center md:text-right w-full">
                      ...
                      >
                        <div className="inline-block px-3 py-0.5 bg-gold-elegant/10 border border-gold-elegant/30 rounded-full mb-3">
                          <span className="text-gold-elegant font-cinzel text-base">
                            {event.year}
                          </span>
                        </div>

                        <h3 className="text-2xl md:text-3xl font-cinzel mb-3 text-white tracking-tight">
                          {event.title}
                        </h3>

                        <div className="prose prose-invert max-w-none">
                          <div
                            className="text-cream/70 leading-relaxed max-w-lg italic font-light line-clamp-2 text-sm"
                        ...
                        <button
                          ...
                          className="mt-3 text-gold-elegant text-[9px] uppercase tracking-[0.2em] font-bold border-b border-gold-elegant/30 hover:border-gold-elegant transition-all pb-1"
                        >
                          Lihat Detail
                        </button>
                      </div>
                    ...
                    <div className="relative z-10 shrink-0">
                      <div className="w-10 h-10 rounded-full bg-matte-black border border-gold-elegant flex items-center justify-center text-gold-elegant shadow-[0_0_20px_rgba(212,175,55,0.2)]">
                        <History size={16} />
                      </div>

                      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-16 h-16 bg-gold-elegant/5 rounded-full blur-xl -z-10" />
                    </div>

                    {/* IMAGE FIX */}
                    <div className="flex-1 w-full">
                      <div className="relative aspect-[16/9] md:aspect-[4/3] rounded-[2rem] overflow-hidden glass border border-white/10 group shadow-xl max-w-md mx-auto md:mx-0">

                        <img
                          src={
                            getImageUrl(event, "/fallback.jpg")
                          }
                          alt={event.title}
                          loading="lazy"
                          onError={(e) => {
              ...
              <div className="text-center py-40 glass rounded-[3rem] border border-white/5">
                <p className="text-cream/40 font-cinzel italic text-2xl">
                  Jejak sejarah tidak ditemukan dalam pencarian...
                </p>
              </div>
            )}
          </div>
          ...
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-6 md:p-12">
            ...
            >
              <div className="w-full md:w-1/2 h-64 md:h-auto relative">
                <img
                  src={
                    getImageUrl(selectedEvent, "/fallback.jpg")
                  }
              ...
              <div className="flex-1 p-8 md:p-16 overflow-y-auto custom-scrollbar">
                ...
                <div className="inline-block px-4 py-1 bg-gold-elegant/10 border border-gold-elegant/30 rounded-full mb-6">
                  <span className="text-gold-elegant font-cinzel text-lg">
                    {selectedEvent.year}
                  </span>
                </div>

                <h2 className="text-4xl md:text-5xl font-cinzel text-white mb-8">
                  {selectedEvent.title}
                </h2>

                <div className="prose prose-invert max-w-none">
                  <div
                    className="text-cream/70 text-lg leading-relaxed italic font-light"
                    dangerouslySetInnerHTML={{
                      __html:
                ...
                <div className="mt-12 pt-8 border-t border-white/5 flex gap-4">
                  ...
                  <div>
                    <span className="block text-[10px] uppercase tracking-widest text-cream/30">
                      Arsip Digital
                    </span>
